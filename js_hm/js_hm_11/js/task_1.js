if (confirm('Почати тестування?')) {
	...
	function getDayName(value) {
		...
		switch (value) {
			...
			case 2: dayName = 'Вівторок'
				break;
			case 3: dayName = 'Середа'
				break;
			case 4: dayName = 'Четвер'
				break;
			case 5: dayName = 'П\'ятниця'
				break;
			case 6: dayName = 'Субота'
				break;
			case 7: dayName = 'Неділя'
				break;
			default: dayName = 'Де я'
				break;
		}
		return dayName
	}
	...
	for (const shop of randMatrix) {
		...
		document.write(`Тиждень за зростанням [${sortShop}]<br>`);
	}
	...
	for (const row of randMatrix) {
		...
		document.write(`Тиждень за спаданням [${maxProfitOfWeek}]<br>`);
	}
